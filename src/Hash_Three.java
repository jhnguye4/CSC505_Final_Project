...
public class Hash_Three {
        ...
        if (filename.endsWith(".txt")) 
        {
            ...
            if (input != null) {
                if (input2 != null) { 
                    ...
                    dictionary = code.cyclicHashTable(helper,function,dictionary,arr);
    ...
    public void spellCheck(Utils helper, HashCodes code, HashFunctions func, ArrayList<LinkedList<String>> dictionary, String word)
    {
        ...
        String temp;
        int index = code.cyclicShiftHashWord(helper,func, noChar);
        boolean found;
        ...
        if(!found){
            if(Character.isUpperCase(word.charAt(0))){
                ...
                index = code.cyclicShiftHashWord(helper,func, temp);
